...
export function HabsComponent({ analysis }: { analysis: Analysis }) {
  return (
    <SmartAccordion type="multiple" defaultValue={["current-bonuses", "future-bonuses", "available-cp-projects"]} storageKey="habs">
      ...
      {analysis.playerFaction.availableBoostProjects.length > 0 && <AccordionItem value="available-boost-projects"><AccordionTrigger><span>Available Boost Projects</span></AccordionTrigger><AccordionContent><HabsAvailableBoostProjects analysis={analysis} /></AccordionContent></AccordionItem>}
