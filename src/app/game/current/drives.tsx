              ...
              <TableRow key={drive.dataName} className={rowClassName}>
                ...
                <TableCell className="text-right">
                  {drive.tanksAffordable} {drive.limitingResourceName && (() => {
                    const ResourceIconMap: Record<string, typeof Water> = { Water, Volatiles, Metals, "NobleMetals": Nobles, Fissiles, Antimatter };
...
// Materials type aliased to avoid conflict with imported Materials
