...
import { Trash2, ArrowDownUp, Building2, Target, Rocket, Shield, Users } from "lucide-react";
...
function OwnedNationsSection({ analysis }: { analysis: Analysis }) {
  const {
    nations,
    playerFaction: { id: playerFactionId },
  } = analysis;
...
export function getResourcesUi(analysis: Analysis): TreeNavItem[] {
  ...
  const children: TreeNavItem[] = [
    {
      ...
      label: "Transactions",
      icon: ArrowDownUp,
      content: <TransactionsSection analysis={analysis} />,
    },
    {
      key: "owned",
      label: "Owned nations",
      icon: Building2,
      content: <OwnedNationsSection analysis={analysis} />,
    },
    {
      key: "spoils",
      label: "Spoil targets",
      icon: Target,
      content: <SpoilTargetsSection analysis={analysis} />,
    },
    {
      key: "space",
      label: "MC/Boost targets",
      icon: Rocket,
      content: <McBoostTargetsSection analysis={analysis} />,
    },
    {
      key: "nation-claims",
      label: "Nation Claims",
...
export type ResourcesTreeItem = TreeNavItem;
