...
export function AlienFleetsSection({ analysis }: { analysis: Analysis }) {
...
export function HumanEnemyFleetsSection({ analysis }: { analysis: Analysis }) {
...
export function PlayerFleetsSection({ analysis }: { analysis: Analysis }) {
...
export function ShipsUnderConstructionSection({ analysis }: { analysis: Analysis }) {
