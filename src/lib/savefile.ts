...
export interface TIFactionState extends BaseState {
  ...
  factionGoals: {
    AssembleFleet?: IDValue[];
    AttackWithFleet?: IDValue[];
    BuildFullBase?: IDValue[];
    BuildFullStation?: IDValue[];
    CaptureNationClean?: IDValue[];
    CaptureNationDirty?: IDValue[];
    DefendWithFleet?: IDValue[];
    FoundBase?: IDValue[];
    FoundPlatform?: IDValue[];
    FoundMaxStation?: IDValue[];
    FoundSurveillanceStation?: IDValue[];
    InvadeEarth?: IDValue[];
    JoinFleet?: IDValue[];
    NeutralizeNation?: IDValue[];
    ProspectSites?: IDValue[];
    RepairFleet?: IDValue[];
    ResupplyFleet?: IDValue[];
    SecureEarthSpace?: IDValue[];
    SendFleet?: IDValue[];
    SurveilEarth?: IDValue[];
    WarOnFaction?: IDValue[];
  };
